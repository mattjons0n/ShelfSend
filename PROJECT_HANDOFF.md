...
- [Backlog build plan](outputs/kindle-bridge-backlog-build-plan.md) — complete Milestone 0–14 build, validation, rollout, and omission plan
- [Release-candidate audit](outputs/kindle-bridge-backlog-feature-audit.md) — current requirement-by-requirement release-candidate audit and final evidence record
- [Implementation build plan](outputs/kindle-bridge-implementation-build-plan.md) and [feature audit](outputs/kindle-bridge-feature-audit.md) — historical pre-backlog implementation records
